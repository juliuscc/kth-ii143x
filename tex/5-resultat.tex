\chapter{Arbetet}
\label{sec:arbetet}
Det här kapitlet presenterar hur arbetet genomfördes. Det diskuterar även frågeställningar som bemöttes samt hur det här arbetet förhåller sig till tidigare implementationer. De fyra underkapitlen i det här kapitlet besvarar en av de fyra praktiska frågorna var som introducerades i kapitel \ref{sec:metod:praktiska-frågor}.
...
Ena halvan av det grafiska användargränssnittet användes en trädstruktur för att presentera tillgängliga inställningar och inställningsgrupper, eller mer generellt representerades JSON-objekt och dess tillgängliga \textit{properties}. Det skulle kunna gå att lägga till grafiska interaktionselement för att erbjuda användaren att lägga och ta bort \textit{properties} från objekt eller element från vektorer, men de JSON-filerna som skulle manipuleras hade bestämd struktur på sina \textit{properties} och vektorer skulle inte hanteras.
